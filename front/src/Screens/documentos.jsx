          ...
          <table className="hidden md:table w-full text-sm my-4">
            <thead>
              <tr className="text-gray-700">
                <th className="py-2 px-2 font-medium border-b text-center">
                  Número
                </th>
                <th className="py-2 px-2 font-medium border-b text-center">
                  Nombre
          ...
          <div className="md:hidden space-y-4">
            <div className="bg-gray-300 p-4 rounded-lg">
              <p className="font-medium text-gray-700">
                Número:<span className="text-gray-500"> 1</span>
              </p>
              <p className="font-medium text-gray-700">
                Nombre:
                <span className="text-gray-500"> Tratamiento Especial</span>
              </p>
              <p className="font-medium text-gray-700">
                Lugar:<span className="text-gray-500"> Clinica Huellitas</span>
              </p>
              <p className="font-medium text-gray-700">
                Ultima Revisión:<span className="text-gray-500"> 01-01-24</span>
              </p>
              <p className="font-medium text-gray-700">
                Hora:<span className="text-gray-500"> 12:12 P.m.</span>
              </p>
            ...
            <div className="flex justify-end my-2 gap-2 mt-2">
              <h1 className="font-medium text-gray-700 mx-2">
                Ver más registros
              </h1>
