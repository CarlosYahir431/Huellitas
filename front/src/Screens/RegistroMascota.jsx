    ...
    return (
        <div className="flex h-screen items-center justify-center bg-gradient-to-r from-pink-100 via-blue-100 to-purple-100">
            <div className="w-full max-w-4xl bg-white shadow-lg rounded-xl overflow-hidden p-8">
                <h2 className="text-4xl font-semibold text-morado text-center my-4">Registrar Mascota</h2>
                <p className="text-gray-500 text-center mt-2">Registra los datos de tu mascota para continuar</p>
                <form className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div className="mb-4">
                            ...
                            ¿Ya no quieres continuar? <a href="#" className="text-[#374BFF]">Regresar</a></p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mb-4">
                            <label className="block text-gray-700">Fotografía de la Mascota</label>
                            ...
                            <div className="mt-4 w-full h-64 bg-gray-100 rounded-xl flex justify-center items-center">
                                {file ? (
                                    ...
                                    <div className="flex justify-center items-center w-full h-full bg-gray-200 rounded-xl">
                                        <span className="text-gray-500 text-lg">Previsualiza tu foto aquí</span>
                                    </div>
                                )}
                            </div>
                        </div>
