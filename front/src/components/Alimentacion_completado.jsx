...
function Alimentacion_completado() {
        ...
        <div className="grid lg:grid-cols-4 xl:grid-cols-6 min-h-screen">
            ...
            <main className="lg:col-span-3 xl:col-span-5  bg-white p-8 h-[100vh] overflow-y-scroll">
                ...
                <div className="text-4xl mb-8 my-12 flex items-center text-red-500  text-sm">
                    <span className="ml-2 text-4xl text-orange-500 font-semibold">Alimentación</span>
                </div>
    ...
    <h4 className="text-xl font-semibold text-center my-1 text-gray-800">Seguimiento de Alimentación</h4>
    <div className="overflow-x-auto md:overflow-hidden rounded-xl">
        ...
        <table className="hidden md:table w-full border border-gray-300 text-center text-white">
            ...
            <tbody>
                <tr>
                    <td className="px-4 py-2 text-gray-600 font-medium">Croquetas</td>
                    <td className="px-4 py-2 text-gray-600 font-medium">
                        <div className="flex items-center justify-center text-gray-500 text-sm">
                            <TbPaperBag />
                            <span className="ml-1 text-xs">100g</span>
                        </div>
                        <div className="flex items-center justify-center text-gray-500 text-sm">
                            <TbClock />
        ...
        <div className="block md:hidden">
            {["Croquetas", "Sobre"].map((alimento, index) => (
                <div key={index} className="mb-4 border border-gray-300 rounded-lg p-4">
                    <h5 className="text-lg font-semibold text-gray-800">{alimento}</h5>
                    ...
                    <div className="p-4 bg-orange-500 rounded-xl flex flex-col justify-between gap-4">
                        ...
                        <div className="flex items-center gap-4 bg-gray-100 rounded-xl p-2">
                            <TbClockExclamation className="text-4xl text-orange-500" />
                            <div>
                        ...
                        <div className="flex items-center gap-4 bg-gray-100 rounded-xl p-2">
                            <TbCheckbox className="text-4xl text-orange-500" />
                            <div>
                    ...
                    <table className="hidden md:table w-full text-sm my-4">
                        ...
                        <tbody>
                            <tr className="text-gray-500">
                                ...
                                <td className="py-2 px-2 text-center">Jarabe</td>
                                <td className="py-2 px-2 text-center">1 Cucharada</td>
                                <td className="py-2 px-2 text-center">Martes</td>
                                <td className="py-2 px-2 text-center">12:12 P.m.</td>
...
export default Alimentacion_completado;